...
router.put(
  "/borrowerinfo",
  Authorization.authorized,
  LoansController.BorrowerInformation
);
router.put(
  "/loandetails",
  Authorization.authorized,
  LoansController.LoanDetails
);
router.put(
  "/salaryinfo",
  Authorization.authorized,
  LoansController.SalaryInformation
);
router.put(
  "/employmenthistory",
  Authorization.authorized,
  LoansController.EmploymentHistory
);
router.put("/coborrower", Authorization.authorized, LoansController.CoBorrower);
router.patch(
  "/loanstatus/:loan_profile",
  Authorization.authorized,
  LoansController.updateLoanStatusReport
);
